...
# Possible improvement: In case of KeyError (file didn't download correctly) download file again
...
def short_term_median():
    longTermMedians = long_term_median()        # In case we don't have enough short term datapoints
